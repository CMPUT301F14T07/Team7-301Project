...
public class Entry {
	...
	/**
	 * Creates a new Entry.
	 * @param post_ The post (main body of text) of the Entry.
	 * @param author_ The person who wrote the Entry.
	 */
	 ...
	 * @param upVote_ How many up votes this entry has.
	 */
	 ...
	 * @param s The post (main body of text) for this Entry.
	 */
	 ...
	 * @param name The person who created this Entry.
	 */
	...
	/** 
	 * Set the picture attached to this Entry. No, it cannot have two picture. Don't be stupid.
